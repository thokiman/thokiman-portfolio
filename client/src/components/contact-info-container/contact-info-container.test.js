...
describe("ContactInfo component", () => {
  ...
  beforeEach(() => {
    const mockProps = {
      ...
      title: mockText,
      items: { socialIcon: mockSocialIconArray, photoIcon: mockPhotoIconArray },
    };
    wrapper = shallow(<ContactInfo {...mockProps} />);
  });

  it("should render ContactInfo component", () => {
